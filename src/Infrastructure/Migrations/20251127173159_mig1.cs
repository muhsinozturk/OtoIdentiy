        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Depots_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_StockPriceTypes", x => x.Id);
                    table.ForeignKey(
                        name: "FK_StockPriceTypes_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    StockPriceTypeId = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_StockPrices_StockPriceTypes_StockPriceTypeId",
                        column: x => x.StockPriceTypeId,
                        principalTable: "StockPriceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkOrderId = table.Column<int>(type: "int", nullable: false),
                    StockId = table.Column<int>(type: "int", nullable: false),
                    StockPriceTypeId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_WorkOrderParts_Depots_DepotId",
                        column: x => x.DepotId,
                        principalTable: "Depots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkOrderParts_StockPriceTypes_StockPriceTypeId",
                        column: x => x.StockPriceTypeId,
                        principalTable: "StockPriceTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_WorkOrderParts_Stocks_StockId",
                        column: x => x.StockId,
                        principalTable: "Stocks",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Inventories_Depots_DepotId",
                        column: x => x.DepotId,
                        principalTable: "Depots",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_StockPrices_StockPriceTypeId",
                table: "StockPrices",
                column: "StockPriceTypeId");

            migrationBuilder.CreateIndex(
                name: "IX_StockPriceTypes_CompanyId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Vehicles_ActId",
                table: "Vehicles",
                column: "ActId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderParts_DepotId",
                table: "WorkOrderParts",
                column: "DepotId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderParts_StockId",
                table: "WorkOrderParts",
                column: "StockId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderParts_StockPriceTypeId",
                table: "WorkOrderParts",
                column: "StockPriceTypeId");
